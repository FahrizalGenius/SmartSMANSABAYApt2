...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; -webkit-tap-highlight-color: transparent; }
        ...
        .btn-header-icon {
            background: rgba(255,255,255, 0.2); width: 45px; height: 45px; border-radius: 14px;
        ...
        .promo-card {
            ...
            border-radius: 24px; padding: 22px; color: white; display: flex; justify-content: space-between;
            align-items: center; position: relative; overflow: hidden; 
            box-shadow: 0 12px 25px rgba(0, 168, 89, 0.3); margin-bottom: 30px;
        }
        .badge-promo {
            background-color: #FFF; color: #00A859; padding: 5px 12px; border-radius: 8px;
        ...
        .cat-card {
            ...
            flex-direction: column; justify-content: flex-end; text-align: left; overflow: hidden;
            box-shadow: 0 8px 15px rgba(0,0,0,0.05); transition: transform 0.1s;
        }
        ...
        .cat-icon-float {
            position: absolute; top: 12px; left: 12px; background: rgba(255,255,255,0.25); width: 32px; height: 32px;
            border-radius: 10px; display: flex; align-items: center; justify-content: center; color: white; font-size: 14px;
        ...
        .product-img-box {
            width: 100%; height: 120px; background-color: #f0f0f0; border-radius: 14px; margin-bottom: 10px;
        ...
        .btn-add {
            width: 32px; height: 32px; background-color: #00A859; border-radius: 10px;
